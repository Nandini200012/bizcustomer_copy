...
// import 'package:reward_hub_customer/store/model/search_vendor_details.dart'; // Import your model class

// class SearchStoreDetailsScreen extends StatefulWidget {
//   final String placeId;

//   const SearchStoreDetailsScreen({Key? key, required this.placeId})
//       : super(key: key);
...
//   List<Vendor> stores = [];
//   int pageNumber = 1;
//   int pageSize = 1000; // Set an initial page size
...
//   ),
//   itemCount: _searchQuery.isEmpty ? stores.length : stores.where((store) =>
//       store.vendorBusinessName
//           .toLowerCase()
//           .contains(_searchQuery)).length,
//   itemBuilder: (context, index) {
//     if (_searchQuery.isEmpty) {
//       if (index < stores.length) {
//         // Render stores
//         return buildVendorItem(stores[index]);
//       } else {
...
//      if (_searchQuery.isNotEmpty && filteredStores.isEmpty) {
//         return Center(
//           child: Text(
//             'No stores available.',
//             style: TextStyle(fontSize: 16),
...
//         return buildVendorItem(filteredStores[index]);
//       }
//     }
//   },
// )
...
//                 //         mainAxisSpacing: 2.0, // Set the spacing between rows
//                 //         childAspectRatio: 3 / 2),
...
//                 //               child: StoreDetails( stores[index]),
//                 //             ),
//                 //           );
//                 //         },
//                 //         child: Container(
...
//                 //             borderRadius: BorderRadius.circular(10),
//                 //             image: stores[index].vendorBusinessPicUrl1 == "null"
...
//                 //                         stores[index].vendorBusinessPicUrl1),
//                 //                     fit: BoxFit.fill,
//                 //                   ),
//                 //           ),
//                 //           child: Stack(
...
//                 //                   child: Text(
//                 //                     stores[index].vendorBusinessName,
...
class StroreFilterStoreDetails extends StatefulWidget {
  ...
  State<StroreFilterStoreDetails> createState() =>
      _StroreFilterStoreDetailsState();
}

TextEditingController _textEditingController = TextEditingController();
FocusNode _searchFocusNode = FocusNode();

class _StroreFilterStoreDetailsState extends State<StroreFilterStoreDetails> {
  List<Vendor> stores = [];
