          ...
          if (selectedDistrictId != null) {
            districtController.text =
                districts.firstWhere(
                  (element) => element['id'] == selectedDistrictId,
                )['name'];
          }
          if (selectedTownId != null) {
            townController.text =
                towns.firstWhere(
                  (element) => element['id'] == selectedTownId,
                )['name'];
          }
          if (selectedPlaceId != null) {
            placeController.text =
                places.firstWhere(
                  (element) => element['id'] == selectedPlaceId,
                )['name'];
          }
        });
      }
